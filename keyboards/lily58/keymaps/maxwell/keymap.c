 ...
 */
 [_QWERTY] = LAYOUT( \
    KC_ESC, KC_SPC, SGUI(KC_LBRC), SGUI(KC_RBRC), KC_NO,          LAG(0), LAG(1), LAG(2), KC_NO, KC_DEL, KC_ENT, KC_BSPC, \
...
[_LOWER] = LAYOUT(
  ...
  KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC,                                         KC_CIRC, KC_AMPR, KC_ASTR, KC_MINS, KC_EQL, KC_DEL,
